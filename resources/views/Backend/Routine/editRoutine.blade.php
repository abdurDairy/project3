        ...
        <div class="col-10 mx-auto">
            ...
            box-shadow:  20px 20px 60px #efccf0,
                ...
                <div style="background: #6a23ee;" class="card-header text-light position-absolute top-0 end-0">
                    <h1 style="font-weight:bold;">Edit Routine</h1>
                </div>
                <div class="card-body">
                    <form action="{{ route('upated.routine',$updateRoutine->id) }}" method="POST" enctype="multipart/form-data" class="px-5">
                        @csrf
                        @method('PUT')
                        ...
                        <select name="semester_select" id="semester_select" class="form-control">
                            ...
                            @foreach ($semester_data as $data)
                              <option value="{{ $data->id }}" @selected($updateRoutine->routine_semester_id == $data->id )>{{ $data->Semester }}</option>
                            @endforeach
                        </select>
